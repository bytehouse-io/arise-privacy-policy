## Privacy Policy for Arise

Company: Steath Company, LLC
...
- **Application**: Arise, the software program provided by the Company.
...
- Email hey@Arise.app with the subject line: "delete account". In the body of your email, make sure to send us the email you signed up with.
- Logout of the app
